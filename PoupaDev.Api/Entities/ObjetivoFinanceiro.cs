...
namespace PoupaDev.API.Entities
{
    ...
    {
        private const decimal RENDIMENTO = 0.10m;
        ...
        public void Render()
        {
            var valorRedimento = Saldo * RENDIMENTO;
            
            Console.WriteLine($"Saldo: {Saldo}, Rendimentos: {valorRedimento}");

            var deposito = new Operacao(valorRedimento, TipoOperacao.Deposito, Id);
